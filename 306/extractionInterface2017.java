package acc_2017_interface_extraction;
...
public class extractionInterface2017 {
		...
		public static void main(String[] args) throws SecurityException, ClassNotFoundException, IOException, IllegalArgumentException, IllegalAccessException {
			...
			String[] listeDesClassesInterfaces = {"org.apache.commons.collections4.ArrayStack",
					"java.util.Stack",
					"java.text.Format",
					"java.text.DateFormat", "java.text.SimpleDateFormat",
					"java.io.Serializable", "java.lang.Cloneable",
					"java.text.MessageFormat", "java.text.NumberFormat","java.text.ChoiceFormat",
			...
			createFileFromList("resultat2017/concrete2017.txt", dFile.getEntityList());
			...
			d4.createTable(2);
			d4.afficheTable();
			d4.ecrireTable("resultat2017/formatConc2017.rcft");
			d4.ecrireTable("resultat2017/formatConc2017.csv");}
	}
